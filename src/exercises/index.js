export const exercises = [
...

  {
    ...
    difficulty: 'Facile',
    statement: 'Combien de clients sont actuellement enregistrés dans la base de données ? Nommez le résultat nb_clients.',
...

  {
    ...
    category: 'agregations',
    difficulty: 'Facile',
    statement: 'Calculez la somme totale des montants de tous les contrats actuellement actifs. Nommez le résultat total_actifs.',
...

  {
    ...
    category: 'agregations',
    difficulty: 'Moyen',
    statement: 'Calculez le montant moyen des contrats pour chaque type de produit proposé par la société. Nommez la colonne calculée montant_moyen.',
...

  {
    ...
    category: 'agregations',
    difficulty: 'Moyen',
    statement: 'Quels sont le montant le plus faible et le montant le plus élevé parmi tous les contrats du portefeuille ? Nommez les colonnes montant_min et montant_max.',
...

  {
    ...
    category: 'agregations',
    difficulty: 'Moyen',
    statement: 'Pour orienter la stratégie commerciale, affichez le nombre de clients par ville, en commençant par les villes les mieux représentées. Nommez le compteur nb_clients.',
...

  {
    ...
    category: 'agregations',
    difficulty: 'Moyen',
    statement: 'Dressez un tableau de bord indiquant combien de contrats sont dans chaque statut (Actif, Suspendu, Clôturé). Nommez le compteur nb_contrats.',
...
INNER JOIN paiements p ON cv.id = p.contrat_id;`,
...

  {
    ...
    category: 'jointures',
    difficulty: 'Difficile',
    statement: 'Calculez le montant total des paiements versés par chaque client ayant effectué au moins un paiement. Affichez son nom, son prénom et le total. Nommez la colonne total total_paiements.',
...
WHERE NOT EXISTS (
...

  {
    ...
    category: 'avancees',
    difficulty: 'Difficile',
    statement: 'Le directeur régional souhaite un classement des conseillers selon le nombre de contrats actifs qu\'ils gèrent, du plus actif au moins actif. Tous les conseillers doivent apparaître, même ceux sans contrat actif. Nommez le compteur nb_contrats_actifs.',
